...
<template>
    ...
    <section>
        <h2>Default</h2>
        <p>아래는 드롭다운 컴포넌트의 기본이며 각각의 요소에는 <strong>value</strong>를 지정할 수 있습니다. (숫자 형태만 가능)</p>
        <div>
    ...
    <section>
        ...
        <p class="br"><strong>keydown</strong> prop을 true로 주면 키보드 방향키를 통해서도 리스트를 선택할 수 있습니다.</p>
    </section>

    <section>
        <h2>Update</h2>
        <p>드롭다운은 마크업 뿐만이 아니라 순수 데이터(items prop)로도 리스트를 구성할 수 있습니다.</p>
        <div class="navbar" style="overflow: hidden;">
            <div class="inline right">
